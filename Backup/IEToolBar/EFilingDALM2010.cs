...
namespace IEToolBar
{
    public class EFilingDALM2010 : EFilingDALB
    {
        public EFilingDALM2010()
        {
        }

        public EFilingDALM2010(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataM2010(string strPage)
        {
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    case "M2010Page1":
                        ...
                        strQuery = "SELECT FORMAT(TP_DOB,'dd/mm/yyyy'), FORMAT(TP_WORKER_APPROVEDATE,'dd/mm/yyyy') " +
                    ...
                    case "M2010Page3":
                        ...
                        "TC_INCOME_TRANSFER_FROM_HW, TC_INSTALLMENT_PAYMENT_SELF, TC_INSTALLMENT_PAYMENT_HW, TC_PROSPECTING, TC_EXEMPT_AMOUNT " +
