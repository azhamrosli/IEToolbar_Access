...
namespace IEToolBar
{
    public class EFilingDALC2012 : EFilingDAL
    {
        public EFilingDALC2012()
        {
        }

        public EFilingDALC2012(string strTaxPayer, string strYA, string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataC2012(string strPage)
        {
            string strQuery = "";
