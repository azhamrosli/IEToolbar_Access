        ...
        private String[] GetEFilingURL(string strType)
        {
            ...
            switch (strYA)
            {
                ...
                case "2015":
                    ...
                    String[] strPURL15 = new String[10];
                ...
                case "2016":
                    ...
                    if (strType == "C")
                    {
                        strCURL16[0] = "https://ef.hasil.gov.my/ec2016PP/mak_sykt.aspx";
                        strCURL16[1] = "https://ef.hasil.gov.my/ec2016PP/mak_pengarah.aspx";
                        strCURL16[2] = "https://ef.hasil.gov.my/ec2016PP/mak_syer.aspx";
                        strCURL16[3] = "https://ef.hasil.gov.my/ec2016PP/pen_kanun.aspx";
                        strCURL16[4] = "https://ef.hasil.gov.my/ec2016PP/per_khas.aspx";
                        strCURL16[5] = "https://ef.hasil.gov.my/ec2016PP/tun_elaun.aspx";
                        strCURL16[6] = "https://ef.hasil.gov.my/ec2016PP/tun_insentif.aspx";
                        strCURL16[7] = "https://ef.hasil.gov.my/ec2016PP/pen_pindah.aspx";
                        strCURL16[8] = "https://ef.hasil.gov.my/ec2016PP/mak_wang.aspx";
                        strCURL16[9] = "https://ef.hasil.gov.my/ec2016PP/lain_cukai.aspx";
                        strCURL16[10] = "https://ef.hasil.gov.my/ec2016PP/lain_transaksi.aspx";
                        strCURL16[11] = "https://ef.hasil.gov.my/ec2016PP/lain_makl.aspx";
                        strCURL16[12] = "https://ef.hasil.gov.my/ec2016PP/juruaudit.aspx";
                        strCURL16[13] = "https://ef.hasil.gov.my/ec2016PP/cukai_dibayar.aspx";
                        strCURL16[14] = "https://ef.hasil.gov.my/ec2016PP/rkt_rks.aspx";
                        strURL = strCURL16;
                    }
