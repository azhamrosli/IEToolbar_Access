...
namespace IEToolBar
{
    public class EFilingDALC2013 : EFilingDAL
    {
        public EFilingDALC2013()
        {
        }

        public EFilingDALC2013(string strTaxPayer, string strYA, string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataC2013(string strPage)
        {
            string strQuery = "";
