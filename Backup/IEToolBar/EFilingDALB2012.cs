...
namespace IEToolBar
{
    public class EFilingDALB2012 : EFilingDALB
    {

        public EFilingDALB2012()
        {
        }


        public EFilingDALB2012(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataB2012(string strPage)
        {
            //LEESH FEB 2012
            string strQuery = "";
