...
namespace IEToolBar
{
    public class EFilingDALP2011: EFilingDALP
    {
        public EFilingDALP2011()
        {
        }


        public EFilingDALP2011(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataP2011(string strPage)
        {
            //LEESH FEB 2012
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    #endregion
                    #region "Page2"
                    case "P2011Page2": //Pendapatan Perniagaan
                        ...
                        #endregion
                    #region "Page3"
                    case "P2011Page3": //Pendapatan Perniagaan
                        strQuery = "SELECT [P_KEY] FROM [PARTNERSHIP_INCOME] WHERE [P_REF_NO]=?  AND P_YA=? ";//LeeCC Partnership
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
