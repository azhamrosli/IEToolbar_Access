...
namespace IEToolBar
{
    public class EFilingDALC2010 : EFilingDAL
    {
        public EFilingDALC2010()
        {
        }

        public EFilingDALC2010(string strTaxPayer, string strYA, string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataC2010(string strPage)
        {
            string strQuery = "";
