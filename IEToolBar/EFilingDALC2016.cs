            ...
            try
            {
                ...
                switch (strPage)
                {
                    case "C2016Page1":
                        ...
                        //strQuery = "select t.tp_residence, t.tp_country, t.tp_public_order, t.tp_co_status, t.tp_reg_state, t.tp_curr_state, t.tp_com_state, b.bk_code, t.tp_record_kept, t.tp_alt_state, left(format(t.tp_acc_period_fr,'dd/mm/yyyy'),2), mid(format(t.tp_acc_period_fr,'dd/mm/yyyy'), 4, 2), right(format(t.tp_acc_period_fr,'dd/mm/yyyy'),4), left(format(t.tp_acc_period_to,'dd/mm/yyyy'),2), mid(format(t.tp_acc_period_to,'dd/mm/yyyy'), 4, 2), right(format(t.tp_acc_period_to,'dd/mm/yyyy'),4), " +
                        //    "left(format(t.tp_basis_period_fr,'dd/mm/yyyy'),2), mid(format(t.tp_basis_period_fr,'dd/mm/yyyy'), 4, 2), right(format(t.tp_basis_period_fr,'dd/mm/yyyy'),4), left(format(t.tp_basis_period_to,'dd/mm/yyyy'),2), mid(format(t.tp_basis_period_to,'dd/mm/yyyy'), 4, 2), right(format(t.tp_basis_period_to,'dd/mm/yyyy'),4), left(format(t.tp_opn_operation,'dd/mm/yyyy'),2), mid(format(t.tp_opn_operation,'dd/mm/yyyy'), 4, 2), right(format(t.tp_opn_operation,'dd/mm/yyyy'),4), " +
                    ...
                    case "C2016Page3":
                        ...
                        //strQuery = "SELECT s.SH_IC, s.SH_NAME, iif(cdbl(b.bs_capital) > 0,(s.sh_share*s.sh_par_value/b.bs_capital)*100,0), s.SH_COUNTRY, s.SH_CHECK, s.SH_SHAREP, left(format(s.SH_DATE_OF_BIRTH,'dd/mm/yyyy'),2), mid(format(s.SH_DATE_OF_BIRTH,'dd/mm/yyyy'), 4, 2), right(format(s.SH_DATE_OF_BIRTH,'dd/mm/yyyy'),4) FROM shareholders_profile AS s, balance_sheet AS b WHERE s.SH_REF_NO=b.bs_ref_no AND s.SH_YA=b.BS_YA AND s.SH_REF_NO=? AND S.SH_YA=? order by s.sh_order";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
