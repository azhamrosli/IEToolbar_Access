...
namespace IEToolBar
{
    public class EFilingDALM2015 : EFilingDALB
    {
        public EFilingDALM2015()
        {
        }

        public EFilingDALM2015(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataM2015(string strPage)
        {
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    case "M2015Page1":
                        ...
                        strQuery = "SELECT FORMAT(TP_DOB,'dd/mm/yyyy'), FORMAT(TP_WORKER_APPROVEDATE,'dd/mm/yyyy'), TP_COM_ADD_STATUS,FORMAT(TP_DOB,'dd/MMM/yyyy'),FORMAT(TP_HW_DOB,'dd/MMM/yyyy') " +
                    ...
                    case "M2015Page2":
                        ...
                        strQuery = "SELECT TP_HW_LAST_PASSPORT_NO, FORMAT(TP_HW_DOB,'dd/mm/yyyy'), TP_COM_ADD_STATUS,FORMAT(TP_DOB,'dd/MMM/yyyy'),FORMAT(TP_HW_DOB,'dd/MMM/yyyy') " +
                        "FROM TAXP_PROFILE2 WHERE TP_REF_NO=?";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer.ToString()));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
