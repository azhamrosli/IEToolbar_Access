...
namespace IEToolBar
{
    public class EFilingDALP2015 : EFilingDALP
    {
        public EFilingDALP2015()
        {
        }


        public EFilingDALP2015(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
                ...
                switch (strPage)
                {
                    ...
                    case "P2015Page7":
                        ...
                        //cmdOdbc.Dispose();
                            ...
                            "PPL_NET_PROFIT,PPL_DISALLOWED_EXP,PPL_LAWYER_COST,PPL_EXP_INT_RES,PPL_NONTAX_IN_TOTAL FROM [P_PROFIT_AND_LOSS] where P_REF_NO=? and P_YA=?"; //LeeCC Partnership
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
