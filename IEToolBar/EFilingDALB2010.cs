...
namespace IEToolBar
{
    public class EFilingDALB2010 : EFilingDALB
    {

        public EFilingDALB2010()
        {
        }

        public EFilingDALB2010(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataB2010(string strPage)
        {
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    case "B2010Page1":
                        ...
                        //weihong 
                        strQuery = "select FORMAT(TP_WORKER_APPROVEDATE,'dd/mm/yyyy') from TAXP_PROFILE2 where TP_REF_NO=?";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer.ToString()));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
