...
namespace IEToolBar
{
    public class EFilingDALP2016 : EFilingDALP
    {
        ...
        public DataSet GetFormDataP2016(string strPage)
        {
            //LEESH FEB 2013
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    case "P2016Page1":
                        ...
                        //32 PT_PRE_PARTNER
                        //33 PT_TEL1 + PT_TEL2
                        //34 PT_MOBILE1 + PT_MOBILE2
                        //35 PT_EMAIL
                        //36 PT_BWA
                        //37 PT_BUSINESS_ECOMMERCE
                        //38 PT_JKDM
                        //39 PT_GST
                        strQuery = "SELECT PT_NAME, PT_REF_NO, " +
                        ...
                        "PT_EMPLOYER_NO2,PT_PRE_PARTNER,PT_TEL1 + PT_TEL2,PT_MOBILE1 + PT_MOBILE2,PT_EMAIL, PT_BWA,PT_BUSINESS_ECOMMERCE,PT_JKDM,PT_GST  " +
                    ...
                    #endregion
                    #region "Page2"
                    case "P2016Page2": //Pendapatan Perniagaan
                        ...
                        break;
                    #endregion
                    #region "Page3 DISABLED"
                    //case "P2016Page3": //Pendapatan Perniagaan
                    //    strQuery = "SELECT [P_KEY] FROM [PARTNERSHIP_INCOME] WHERE [P_REF_NO]=?  AND P_YA=? ";//LeeCC Partnership
                    //    cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                    //    cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                    //    cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                    ...
                    case "P2016Page5":
                        ...
                        strQuery = "SELECT P_CP30_ASAL,P_CP30_ASAL_DATE, P_CP30_PINDAAN,P_CP30_PINDAAN_DATE FROM [PARTNERSHIP_INCOME]  where [P_KEY]=?";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                    ...
                    case "P2016Page7":
                        ...
                        strQuery = "SELECT [PS_CODE],[PS_TYPE] FROM [TAXP_PSOURCE] where PS_REF_NO=? and PS_YA=?";
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
                        ...
                        //    "PPL_OTH_BSIN,PPL_OTH_IN_DIVIDEND,PPL_OTH_IN_INTEREST,PPL_OTH_IN_RENTAL_ROYALTY,Cint(PPL_OTH_IN_OTHER) + Cint(PPL_NONTAX_IN_TOTAL)," +
                        //    "PPL_EXP_LOANINTEREST,PPL_EXP_SALARY,PPL_EXP_RENTAL,PPL_EXP_CONTRACT,PPL_EXP_COMMISSION," +
                        //    "PPL_BAD_DEBTS,PPL_TRAVEL,PPL_EXP_REPAIR_MAINT,PPL_EXP_PRO_ADV, Cint(PPL_OTHER_EXP) + Cint(PPL_LAWYER_COST) + Cint(PPL_EXP_INT_RES), " +
                        ...
                        //0 PPL_SALES
                        //1 PPL_OP_STK
                        //2 PPL_PURCHASES_COST
                        //3 PPL_CLS_STK
                        //4 PPL_COGS
                        //5 PPL_OTH_BSIN
                        //6 PPL_OTH_IN_DIVIDEND
                        //7 PPL_OTH_IN_INTEREST
                        //8 PPL_OTH_IN_RENTAL_ROYALTY
                        //9 PPL_OTH_IN_OTHER
                        //10 PPL_EXP_LOANINTEREST
                        //11 PPL_EXP_SALARY
                        //12 PPL_EXP_RENTAL
                        //13 PPL_EXP_CONTRACT
                        //14 PPL_EXP_COMMISSION
                        //15 PPL_BAD_DEBTS
                        //16 PPL_TRAVEL
                        //17 PPL_EXP_REPAIR_MAINT
                        //18 PPL_EXP_PRO_ADV
                        //19 PPL_OTHER_EXP
                        //20 PPL_NET_PROFIT
                        //21 PPL_DISALLOWED_EXP
                        //22 PPL_LAWYER_COST
                        //23 PPL_EXP_INT_RES
                        //24 PPL_NONTAX_IN_TOTAL
                        //25 PPL_JDKM
                            ...
                            "PPL_NET_PROFIT,PPL_DISALLOWED_EXP,PPL_LAWYER_COST,PPL_EXP_INT_RES,PPL_NONTAX_IN_TOTAL,PPL_JKDM FROM [P_PROFIT_AND_LOSS] where P_REF_NO=? and P_YA=?"; //LeeCC Partnership
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
                        daOdbc = new OdbcDataAdapter(cmdOdbc);
