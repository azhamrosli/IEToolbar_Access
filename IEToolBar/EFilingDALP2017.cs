...
namespace IEToolBar
{
    public class EFilingDALP2017 : EFilingDALP
    {
        public EFilingDALP2017()
        {
        }


        public EFilingDALP2017(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataP2017(string strPage)
        {
            //LEESH FEB 2013
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    #endregion
                    #region "Page2"
                    case "P2017Page2": //Pendapatan Perniagaan
                    ...
                    #endregion
                    #region "Page3"
                    case "P2017Page3": //Pendapatan Perniagaan
                        strQuery = "SELECT [P_KEY] FROM [PARTNERSHIP_INCOME] WHERE [P_REF_NO]=?  AND P_YA=? ";//LeeCC Partnership
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
