...
namespace IEToolBar
{
    public class EFilingDALBE2010 : EFilingDALB
    {
        
        public EFilingDALBE2010()
        {
        }

        public EFilingDALBE2010(string strTaxPayer, string strYA, string strTaxAgent)// string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataBE2010(string strPage)
        {
            string strQuery = "";
