    ...
    class EFilingProcessHK3
    {
        ...
        public void ProcessDocument(mshtml.HTMLDocument htmlDoc)
        {
            switch (this.strYA)
            {
                ...
                //simkh 2014
                case "2013":
                    ProcessFormHK32013(htmlDoc);
                    break;
                //simk end

                case "2014":
                    ProcessFormHK32014(htmlDoc);
                    break;

                case "2015":
                    ProcessFormHK32015(htmlDoc);
                    break;
        ...
        private void ProcessFormHK32013(mshtml.HTMLDocument htmlDoc)
        {
            //LEESH FEB 2012
            boolFilled = false;
            foreach (mshtml.HTMLInputElement inpElement1 in htmlDoc.getElementsByTagName("textarea"))
        ...
        private void ProcessFormHK32014(mshtml.HTMLDocument htmlDoc)
        {
            //LEESH FEB 2012
            boolFilled = false;
            foreach (mshtml.HTMLInputElement inpElement1 in htmlDoc.getElementsByTagName("textarea"))
        ...
        private void ProcessFormHK32015(mshtml.HTMLDocument htmlDoc)
        {
            //azham 2015
            boolFilled = false;
            foreach (mshtml.HTMLInputElement inpElement1 in htmlDoc.getElementsByTagName("textarea"))
