...
namespace IEToolBar
{
    public class EFilingDALC2009 : EFilingDAL
    {
        public EFilingDALC2009()
        {
        }

        public EFilingDALC2009(string strTaxPayer, string strYA, string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataC2009(string strPage)
        {
            string strQuery = "";
