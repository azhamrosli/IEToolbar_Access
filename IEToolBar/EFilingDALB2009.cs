...
namespace IEToolBar
{
    public class EFilingDALB2009 : EFilingDALB
    {

        public EFilingDALB2009()
        {
        }

        public EFilingDALB2009(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataB2009(string strPage)
        {
            string strQuery = "";
