...
namespace IEToolBar
{
    public class EFilingDALM2009 : EFilingDALB
    {
        public EFilingDALM2009()
        {
        }

        public EFilingDALM2009(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataM2009(string strPage)
        {
            string strQuery = "";
