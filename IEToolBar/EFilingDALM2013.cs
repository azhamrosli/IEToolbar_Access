...
namespace IEToolBar
{
    public class EFilingDALM2013 : EFilingDALB
    {
        public EFilingDALM2013()
        {
        }

        public EFilingDALM2013(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataM2013(string strPage)
        {
            string strQuery = "";
