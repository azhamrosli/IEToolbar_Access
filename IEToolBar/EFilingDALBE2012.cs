...
namespace IEToolBar
{
    public class EFilingDALBE2012 : EFilingDALB
    {

        public EFilingDALBE2012()
        {
        }


        public EFilingDALBE2012(string strTaxPayer, string strYA, string strTaxAgent)// string strAuditor, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataBE2012(string strPage)
        {
            string strQuery = "";
