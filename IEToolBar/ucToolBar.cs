...
//        }
            ...
            if (SelectedTaxPayertoolStripLabel.Text != "")
            {
                ...
                try
                {
                   // SHDocVw.
                    ...
                    {
                       // MessageBox.Show("URL : " + ieTemp.LocationURL.ToString().ToLower(), "TAXcom E-Filing", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        switch (strFormType)
                        {
                            case "C":case "R":
                        ...
                        if (strDocName.Length > 0)
                        {
                            ...
                            //azham
                            if (strDocName.Contains(strFormType ) == true)
                            {
                    ...
                    frmShell = new frmShellList(swTemp, strDocName);
                    frmShell.Show();
                    }
                    if (boolTargetFound == false)
                    {
                        MessageBox.Show("No relevant document is found for E-Filling (Form " + strFormType + ")! = Doc Name : " + DocName, "TAXcom E-Filing", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        MessageBox.Show("Document Compare : " + DocName.Substring(0, strFormType.Trim().Length) + " : " + strFormType, "TAXcom E-Filing", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
        ...
        private void selectHK6ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (strFormType == "B")
            {
                if (SelectedTaxPayertoolStripLabel.Text.Length > 0)
                {
                    frmHK6 frmHK6 = new frmHK6(strTaxPayer, strYA, "B", "SELF");
                    frmHK6.Show();
                }
                else
                {
            ...
            else if (strFormType == "BE")
            {
                if (SelectedTaxPayertoolStripLabel.Text.Length > 0)
                {
                    frmHK6 frmHK6 = new frmHK6(strTaxPayer, strYA, "BE", "SELF");
                    frmHK6.Show();
                }
                else
                {
            ...
            else if (strFormType == "M")
            {
                if (SelectedTaxPayertoolStripLabel.Text.Length > 0)
                {
                    frmHK6 frmHK6 = new frmHK6(strTaxPayer, strYA, "M", "SELF");
                    frmHK6.Show();
                }
                else
                {
            ...
            {
                MessageBox.Show("HK-6 is not available in Form " + strFormType + "!", "TAXcom E-Filing", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }

        private void ToolbartoolStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
