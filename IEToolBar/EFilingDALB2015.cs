...
namespace IEToolBar
{
    public class EFilingDALB2015 : EFilingDALB
    {

        public EFilingDALB2015()
        {
        }


        public EFilingDALB2015(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataB2015(string strPage)
        {
            //LEESH FEB 2012
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    case "B2015Page1": case "B2015Page2": case "B2015Page3":
