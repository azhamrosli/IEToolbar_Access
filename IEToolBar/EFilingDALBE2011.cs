...
namespace IEToolBar
{
    public class EFilingDALBE2011 : EFilingDALB
    {
        
        public EFilingDALBE2011()
        {
        }


        public EFilingDALBE2011(string strTaxPayer, string strYA, string strTaxAgent)// string strAuditor, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataBE2011(string strPage)
        {
            //LEESH FEB 2012
