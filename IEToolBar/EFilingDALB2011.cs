...
namespace IEToolBar
{
    public class EFilingDALB2011 : EFilingDALB
    {

        public EFilingDALB2011()
        {
        }


        public EFilingDALB2011(string strTaxPayer, string strYA, string strTaxAgent)
        {
            //LEESH FEB 2012
        ...
        public DataSet GetFormDataB2011(string strPage)
        {
            //LEESH FEB 2012
            string strQuery = "";
            ...
            try
            {
                ...
                switch (strPage)
                {
                    ...
                    case "B2011Page3":
                        ...
                        //LEESH 24 FEB 2012
                        strQuery = "select tc_statutory_income, tc_businessloss_bf, tc_aggregate_bus_income, tc_employment_income, tc_dividend, (cdbl(tc_interest) + cdbl(tc_discount)), (cdbl(tc_rental_royalty)+cdbl(tc_premium)), tc_pension_and_etc,(cdbl(tc_other_gain_profit) + cdbl(tc_sec4a)), tc_addition_43, tc_aggregate_other_src, tc_businessloss_cy, tc_prospecting, tc_qualifying_ag_exp, tc_key, tc_prospecting,tc_qualifying_ag_exp, tc_4, tc_3, tc_total_income_2, tc_income_transfer_from_hw, tc_total_income_3, (cdbl(tc_installment_payment_self) + cdbl(tc_installment_payment_hw)),tc_exhk3_transfer_from_hw from tax_computation where tc_ref_no =? and tc_ya =?";
                        //LEESH END
                        cmdOdbc = new OdbcCommand(strQuery, connOdbc);
                        cmdOdbc.Parameters.Add(new OdbcParameter("@taxpayer", strTaxPayer));
                        cmdOdbc.Parameters.Add(new OdbcParameter("@ya", strYA));
