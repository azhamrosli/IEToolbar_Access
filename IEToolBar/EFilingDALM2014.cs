...
namespace IEToolBar
{
    public class EFilingDALM2014 : EFilingDALB
    {
        public EFilingDALM2014()
        {
        }

        public EFilingDALM2014(string strTaxPayer, string strYA, string strTaxAgent)
        {
        ...
        public DataSet GetFormDataM2014(string strPage)
        {
            string strQuery = "";
